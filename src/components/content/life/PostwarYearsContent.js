    ...
    <>
      <div className={styles.basicTopPartOfPage}>
        ...
        <div className="lg:w-[90%]">
          <p className={styles.basicParagraph}><em className="text-[#d66382] font-bold uppercase">{translate('In May 1921')}</em> {translate('postwar years short')}</p>
        </div>
      </div>

      <div>
        <p className={styles.basicParagraph}>{translate('postwar years paragraph')} </p>
      </div>
    </>
  )
};
